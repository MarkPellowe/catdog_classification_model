...
class CatDogClassifier:
     def __init__(self):
        filename = "pet_conv_net_model.pth"
        if not os.path.exists(filename):
            model_path = os.path.join("https://connectionsworkshop.blob.core.windows.net/pets", filename)
     ...
     def predict(self, input):
        ...
        transform_input = transforms.Compose([ transforms.Resize((256,256)), transforms.Normalize(mean=[ 82.18, 139.30, 140.27],std=[49.40, 35.24, 37.86],) ]) 
